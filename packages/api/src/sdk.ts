...
export type GenerateDeviceTokenPayload = {
  __typename?: 'GenerateDeviceTokenPayload';
  token: Scalars['String'];
};

export type GenerateNamePayload = {
  __typename?: 'GenerateNamePayload';
  name: Scalars['String'];
};

export type GenerateSubdomainPayload = {
  __typename?: 'GenerateSubdomainPayload';
...
export type GenerateDeviceTokenQuery = (
  ...
  & { generateDeviceToken: (
    { __typename?: 'GenerateDeviceTokenPayload' }
    & Pick<GenerateDeviceTokenPayload, 'token'>
  ) }
);
